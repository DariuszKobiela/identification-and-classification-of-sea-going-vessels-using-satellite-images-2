...
test_counter = copy_pictures_and_labels(source_path=CUTTED_AND_ANNOTATED_ASF_DATA_PATH,
...
train_counter = copy_pictures_and_labels(source_path=CUTTED_AND_ANNOTATED_ASF_DATA_PATH,
...
val_counter = copy_pictures_and_labels(source_path=CUTTED_AND_ANNOTATED_ASF_DATA_PATH,
